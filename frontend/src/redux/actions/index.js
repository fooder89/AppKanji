import {/* k1_DATA_REQUESTED, k1_DATA_LOADED, k2_DATA_REQUESTED, k2_DATA_LOADED, k1, k2, GET_USER_DATA,*/ USER_DATA_LOADED, IS_ANSWERED } from '../constants/actionTypes'
...
export function isAnswered(payload){
  return { type: IS_ANSWERED, payload }
}